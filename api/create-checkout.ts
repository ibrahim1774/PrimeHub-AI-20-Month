...
export default async function handler(req: any, res: any) {
    ...
    try {
        ...
        const description = isLocalbusiness29
            ...
            : isBarberTwentyNine
            ? (barberTwentyNineTier === 'multi'
                ? `$49${currencyLabel} one-time multi-page (5–15 pages) custom barbershop website design.`
                : `$29${currencyLabel} one-time single-page custom barbershop website design.`)
            : isBarber19
            ? (barber19Tier === 'multi'
            ...
            line_items: [
                {
                    price_data: {
                        ...
                        unit_amount: isBarberTwentyNine ? (barberTwentyNineTier === 'multi' ? 4900 : 2900) : isLocalbusiness29 ? (localbusiness29Tier === 'multi' ? 4900 : 2900) : isBarber19 ? (barber19Tier === 'multi' ? 3900 : 1900) : isNineteen ? 1900 : isYearly ? yearlyAmountCents : monthlyAmountCents,
