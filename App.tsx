...
const App: React.FC = () => {
  ...
  if (pathname === '/1' || pathname === '/aus' || pathname === '/10' || pathname === '/5' || pathname === '/19' || pathname === '/barber' || pathname === '/local-business' || pathname === '/freewebsite') {
    const region =
      pathname === '/aus' ? 'aus' :
      pathname === '/10' ? 'ten' :
      pathname === '/5' ? 'five' :
      ...
      pathname === '/freewebsite' ? 'freewebsite' : 'us';
