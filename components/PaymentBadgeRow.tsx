...
// Trusted-checkout badge row: highlights PayPal as the processor and shows
// real card-network logos so visitors immediately know they can pay with
// any major card without needing a PayPal account.
...
const PayPalMark: React.FC<{ height?: number }> = ({ height = 14 }) => (
    <svg height={height} viewBox="0 0 124 33" xmlns="http://www.w3.org/2000/svg" aria-label="PayPal">
...
const VisaMark: React.FC = () => (
    <svg height="14" viewBox="0 0 60 20" xmlns="http://www.w3.org/2000/svg" aria-label="Visa">
        <text x="30" y="15" textAnchor="middle" fill="#1A1F71" fontFamily="Arial Black, Arial, sans-serif" fontWeight="900" fontSize="16" fontStyle="italic" letterSpacing="0.5">VISA</text>
    </svg>
);
